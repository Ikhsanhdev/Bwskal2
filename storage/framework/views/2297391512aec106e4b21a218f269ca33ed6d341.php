...
<div class="admin-section"
  ...
  <div class="card card-search-box">
    <div class="card-header">
      <div class="title">
        <div>Daftar <?php echo e($title); ?> <span v-if="isFiltered" class="fz-0-9rem font-weight-normal text-primary">(Terfilter)</span></div>
      </div>
      <div class="flex"></div>
...
<script>
  $(document).ready(function () {
    ...
    $('#btnTambah').on('click', function (e) {
      e.preventDefault();
      AKModal.open(`<?php echo e(route('admin.gallery.create')); ?>`);
    });
  });
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sda/balai/bwskalimantan2/resources/views/admin/gallery/index.blade.php ENDPATH**/ ?>