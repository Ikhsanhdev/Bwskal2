...
<?php $__env->startSection('content'); ?>
  ...
  <div class="admin-content-title">
    ...
    <div class="font-weight-bold fz-normal ml-2">Kontak WA</div>
  </div>
  ...
  <div class="admin-section">
    <form class="card"
      id="formnya"
      method="POST"
      action="<?php echo e(route('admin.pengaturan-situs.update', ['page' => 'floating-wa'])); ?>">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sda/balai/bwskalimantan2/resources/views/admin/pengaturan-situs/floating-wa.blade.php ENDPATH**/ ?>