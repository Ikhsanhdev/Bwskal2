      ...
      <div class="col-12">
        <div class="page-top-wrap">
          ...
          <div class="fz-0-85rem text-center text-md-left d-flex flex-column flex-md-row">
            <div>Diterbitkan oleh <span class="fw-700">{{ $data->author }}</span> pada <span class="fw-700">{{ $data->created_at->isoFormat('DD MMMM YYYY') }}</span></div>
            <div class="d-none d-md-block px-1">|</div>
            <div>Dilihat {{ $data->hit }} kali</div>
          </div>
        </div>
      </div>
    </div>
