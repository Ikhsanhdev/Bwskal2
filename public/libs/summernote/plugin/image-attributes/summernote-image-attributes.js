  ...
  $.extend($.summernote.plugins, {
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var body = '<ul class="nav note-nav nav-tabs note-nav-tabs" role="tablist">' +
                   '  <li class="nav-item"><a href="#note-imageAttributes' + timestamp + '" class="nav-link" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>' +
                   '  <li class="nav-item"><a href="#note-imageAttributes-attributes' + timestamp + '" class="nav-link"  data-toggle="tab">' + lang.imageAttributes.tabAttributes + '</a></li>' +
                   '  <li class="nav-item"><a href="#note-imageAttributes-link' + timestamp + '" class="nav-link"  data-toggle="tab">' + lang.imageAttributes.tabLink + '</a></li>';
        if (options.imageAttributes.disableUpload == false) {
           body += '  <li class="nav-item"><a href="#note-imageAttributes-upload' + timestamp + '" class="nav-link"  data-toggle="tab">' + lang.imageAttributes.tabUpload + '</a></li>';
        }
        body +=    '</ul>' +
